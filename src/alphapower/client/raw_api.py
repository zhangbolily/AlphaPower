...
def ENDPOINT_ALPHA_YEARLY_STATS(alpha_id: str) -> str:
    """
    获取 alpha 的年度统计数据的端点。
    :param alpha_id: alpha 的唯一标识符
    :return: 年度统计数据的端点 URL
    """
    return f"alphas/{alpha_id}/recordsets/yearly-stats"


def ENDPOINT_ALPHA_PNL(alpha_id: str) -> str:
    """
    获取 alpha 的收益数据的端点。
    :param alpha_id: alpha 的唯一标识符
    :return: 收益数据的端点 URL
...
def ENDPOINT_ALPHA_SELF_CORRELATIONS(alpha_id: str, correlation_type: str) -> str:
    """
    获取 alpha 的自相关性数据的端点。
    :param alpha_id: alpha 的唯一标识符
    :param correlation_type: 相关性类型（例如 "self"）
    :return: 自相关性数据的端点 URL
    """
